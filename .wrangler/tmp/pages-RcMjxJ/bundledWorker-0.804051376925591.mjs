...
// ../.wrangler/tmp/bundle-dr4MqY/checked-fetch.js
...
var B = (e) => Array.isArray(e);
var Ee = (e) => typeof e == "string";
var oe = (e) => typeof e == "function";
var U = (e) => e && typeof e.then == "function";
var cn = (e, t, n) => {
  try {
    const s = e();
...
var N = (e, t) => U(e) ? e.then(t) : t(e);
var ss = (e) => e.some(U) ? Promise.all(e) : e;
...
var Mo = class {
  ...
  deleteProperty(t, n) {
    if (2 & t[st])
      throw V(17);
    return typeof n == "string" && delete t[n] && (this.$manager$.$notifySubs$(B(t) ? void 0 : n), true);
  }
  get(t, n) {
    var a;
    if (typeof n == "symbol")
    ...
    return r ? Wi(l, this.$containerState$) : l;
  }
  set(t, n, s) {
    if (typeof n == "symbol")
      return t[n] = s, true;
  ...
  ownKeys(t) {
    ...
    return B(t) ? Reflect.ownKeys(t) : Reflect.ownKeys(t).map((s) => typeof s == "string" && s.startsWith("$$") ? s.slice(2) : s);
  }
  getOwnPropertyDescriptor(t, n) {
    return B(t) || typeof n == "symbol" ? Object.getOwnPropertyDescriptor(t, n) : { enumerable: true, configurable: true };
  }
};
var Vi = (e) => e === C || j(e);
var Wi = (e, t) => {
...
var Qi = (e, t) => (e.$parentCtx$ === void 0 && (e.$parentCtx$ = Ui(e.$element$, t)), e.$parentCtx$);
var qo = (e, t, n) => {
  var r;
  const s = e.id;
  if (!t)
...
var ce = (e, t, n, s, o, r) => {
  ...
  if (e != null && typeof e != "boolean") {
    if (!Ee(e) && typeof e != "number") {
      ...
      return U(e) ? (s.write(Vt), e.then((c) => ce(c, t, n, s, o, r))) : void _e();
    }
    s.write(Ln(String(e)));
  }
};
var Vo = (e, t, n, s, o) => {
  ...
  return e.reduce((l, a, u) => {
    ...
    if (l || U(f)) {
      ...
      return U(f) ? l ? Promise.all([f, l]).then(m) : f.then(m) : l.then(m);
    }
    i++;
  }, void 0);
};
...
var Yo = (e, t) => {
  ...
  let a = de;
  return r != null ? N(Ce(r, t), (u) => (u !== void 0 && (a = B(u) ? u : [u]), new Se(l, o, c, a, i, n))) : new Se(l, o, c, a, i, n);
};
var hc = (e, t) => {
  const n = t === void 0 ? de : B(t) ? t : [t], s = new Se(":virtual", {}, null, n, 0, null);
  return s.$elm$ = e, s;
};
var Ce = (e, t) => {
  if (e != null && typeof e != "boolean") {
    ...
    return U(e) ? e.then((n) => Ce(n, t)) : e === fs ? new Se(":skipRender", te, null, de, 0, null) : void _e();
  }
};
...
var Fe = (e, t) => {
  ...
  s(true), e.$resolveLazy$(c.$containerEl$), i.$tasks$ || (i.$tasks$ = []), i.$tasks$.push(l), cr(o, () => sr(l, c, o.$renderCtx$)), se() && Bn(l, t == null ? void 0 : t.eagerness);
};
var D = (e) => {
...
var fn = (e, t) => {
  ...
  if (n)
    return void (se() && Bn(n, c));
  const l = new qt(er, o, i.$element$, e, void 0), a = r.$renderCtx$.$static$.$containerState$;
  i.$tasks$ || (i.$tasks$ = []), i.$tasks$.push(l), s(l), Bn(l, c), se() || (e.$resolveLazy$(a.$containerEl$), hs(l, a));
};
...
var Bn = (e, t) => {
  t === "visible" || t === "intersection-observer" ? Fi("qvisible", En(e)) : t === "load" || t === "document-ready" ? Ks("qinit", En(e)) : t !== "idle" && t !== "document-idle" || Ks("qidle", En(e));
};
var En = (e) => {
  const t = e.$qrl$;
...
var J = (e, t) => {
  ...
  if (o) {
    ...
    if (s.$id$ = o, r) {
      ...
      if (Dc(e)) {
        const a = l[o];
        a && (s.$refMap$ = a.split(" ").map(i), s.li = Bi(s, t.$containerEl$));
      } else {
...
var ve = () => {
  if (!bt) {
    ...
    return e ? B(e) ? document.__q_context__ = lr(e) : e : void 0;
  }
  return bt;
};
var jc = () => {
...
var Zt = (e) => {
  if (Oe(e)) {
    const t = new Se(e.localName, {}, null, Jt, 0, Wn(e));
    return t.$elm$ = e, t;
  }
  if (Zn(e)) {
    ...
    if ("q:renderFn" in u) {
      ...
      const k2 = N(ps(e, m, n), () => {
        ...
        for (const O2 in A2) {
          ...
          let Z2 = n & ~ee;
          Xe3.isSvg && (Z2 |= ee);
          for (const W2 of L2.$children$) {
            const gt2 = Ve(ye2, W2, Z2, w);
            W2.$elm$, W2.$elm$, Er($2, Xe3, gt2);
          }
        }
        return nt(w);
      });
      return U(k2) && s.push(k2), c;
    }
    if ("q:s" in u)
...
var xl = (e) => {
  ...
  for (const [n, s] of e.$addSlots$) {
    const o = Wn(n), r = ot(s, Vn).find((i) => i.getAttribute(re) === o);
    r && (ot(r, en).forEach((i) => {
      Et(n, i);
    }), r.remove());
  }
...
var Al = async (e, t) => {
  ...
  if (ae(o, "q:container") === "paused")
    throw V(21);
  const r = t ?? (o === n.documentElement ? n.body : o), i = mt(o), c = ql(o, Fl);
  ...
  const l = await Ml(c, i, (f) => Ne(f) && Zn(f) ? Wl(f, i) : null), a = n.createElement("script");
...
var Un = Symbol();
var zl = (e) => e.then((t) => (e[Un] = { resolved: true, value: t }, t), (t) => (e[Un] = { resolved: false, value: t }, t));
var Rr = (e) => e[Un];
var q = (e, t, n) => {
  if (e != null) {
    const s = typeof e;
...
var Bl = (e) => Pe(e) && e.hasAttribute("q:container");
var Fl = (e) => {
  const t = Rs(e);
  if (Oe(t)) {
    const n = ie(t);
...
var Ms = (e, t = {}) => {
  ...
  return l && l.length ? t.$getObjId$ ? i += `[${We(l, t.$getObjId$, " ")}]` : t.$addRefMap$ && (i += `[${We(l, t.$addRefMap$, " ")}]`) : c && c.length > 0 && (i += `[${c.join(" ")}]`), i;
};
var qs = (e, t, n) => {
  n.$element$;
  const s = { $containerState$: t, $addRefMap$: (o) => Ul(n.$refMap$, o) };
  return We(e, (o) => Ms(o, s), `
`);
};
var hn = (e, t) => {
...
var Yl = F({ $prefix$: "", $test$: (e) => Ps(e), $collect$: (e, t, n) => {
  if (e.$captureRef$)
...
var Xl = F({ $prefix$: "", $test$: (e) => e instanceof URL, $serialize$: (e) => e.href, $prepare$: (e) => new URL(e) });
var Zl = F({ $prefix$: "", $test$: (e) => e instanceof Date, $serialize$: (e) => e.toISOString(), $prepare$: (e) => new Date(e) });
var ea = F({ $prefix$: "\x07", $test$: (e) => e instanceof RegExp, $serialize$: (e) => `${e.flags} ${e.source}`, $prepare$: (e) => {
  const t = e.indexOf(" "), n = e.slice(t + 1), s = e.slice(0, t);
  return new RegExp(n, s);
} });
var ta = F({ $prefix$: "", $test$: (e) => e instanceof Error, $serialize$: (e) => e.message, $prepare$: (e) => {
  const t = new Error(e);
  return t.stack = void 0, t;
} });
var na = F({ $prefix$: "", $test$: (e) => !!e && typeof e == "object" && Eo(e), $prepare$: (e, t, n) => n });
var nn = Symbol("serializable-data");
var sa = F({ $prefix$: "", $test$: (e) => Vr(e), $serialize$: (e, t) => {
  const [n] = e[nn];
...
var oa = F({ $prefix$: "", $test$: (e) => e instanceof Fn, $collect$: (e, t, n) => {
  if (e.$args$)
  ...
  return o < 0 && (o = n.$inlinedFunctions$.length, n.$inlinedFunctions$.push(s)), We(e.$args$, t, " ") + " @" + Ae(o);
}, $prepare$: (e) => {
...
var ra = F({ $prefix$: "", $test$: (e) => e instanceof _t, $collect$: (e, t, n) => (q(e.untrackedValue, t, n), n === true && !(e[kt] & dr) && dt(e[fe], t, true), e), $serialize$: (e, t) => t(e.untrackedValue), $prepare$: (e, t) => {
  var n;
...
var ia = F({ $prefix$: "", $test$: (e) => e instanceof Dn, $collect$(e, t, n) {
...
var ca = F({ $prefix$: "", $test$: (e) => typeof e == "number", $serialize$: (e) => String(e), $prepare$: (e) => Number(e) });
var la = F({ $prefix$: "", $test$: (e) => e instanceof URLSearchParams, $serialize$: (e) => e.toString(), $prepare$: (e) => new URLSearchParams(e) });
var aa = F({ $prefix$: "", $test$: (e) => typeof FormData < "u" && e instanceof globalThis.FormData, $serialize$: (e) => {
  const t = [];
...
var ua = F({ $prefix$: "", $test$: (e) => Ke(e), $collect$: (e, t, n) => {
...
var $a = F({ $prefix$: "", $test$: (e) => typeof e == "bigint", $serialize$: (e) => e.toString(), $prepare$: (e) => BigInt(e) });
var ct = Symbol();
var da = F({ $prefix$: "", $test$: (e) => e instanceof Set, $collect$: (e, t, n) => {
  e.forEach((s) => q(s, t, n));
...
var fa = F({ $prefix$: "", $test$: (e) => e instanceof Map, $collect$: (e, t, n) => {
  e.forEach((s, o) => {
    q(s, t, n), q(o, t, n);
  });
}, $serialize$: (e, t) => {
...
var pa = F({ $prefix$: "\x1B", $test$: (e) => !!Nr(e) || e === gn, $serialize$: (e) => e, $prepare$: (e) => e });
...
var mp = (e, t) => Qn(e, /* @__PURE__ */ new Set(), "_", t);
var Qn = (e, t, n, s) => {
  const o = Lt(e);
  if (o == null)
    return e;
...
var Ta = class {
  ...
  $addSub$(t, n) {
    ...
    t[0] === 0 && s.some(([r, i, c]) => r === 0 && i === o && c === n) || (s.push(Fr = [...t, n]), this.$addToGroup$(o, this));
  }
  $notifySubs$(t) {
    const n = this.$subs$;
    for (const s of n) {
...
var Sn = (e, t, n, s, o, r, i) => {
  ...
  const m = (d) => d == null ? le() : B(d) ? lr(d) : d, g2 = i ?? t, b = Dr(g2);
...
var Na = (e, t) => {
  ...
  for (; r < n; ) {
    ...
    for (let d = 0; d < b.length; d++) {
      ...
      if ((v3 === l || v3 === R || v3 === sn && Wt(l) || v3 === Hn && fo(l)) && (y === g2 || y === R || y === sn && Wt(g2) || y === be && !Wt(g2) && g2 !== zs || y === Hn && fo(g2)) && (p.length == 3 || $2(p))) {
        if (p.length > 3 && (g2 = e.charCodeAt(r - 1)), h === Q || h == Be) {
          h === Be && (c !== Wr || f() ? $o(g2) || u(r - (y == be ? 1 : y == jn ? 2 : 0)) : ($o(g2) ? a(r - 2) : u(r - 2), i++)), y === be && (r--, g2 = l);
          do
            c = o.pop() || lt, c === De && (a(r - 1), i++);
          while (Pa(c));
        } else
          o.push(c), c === De && h === lt ? (a(r - 8), i = r) : h === Ur && u(m), c = h;
        break;
      }
    }
    l = g2;
...
var Wt = (e) => e >= Fa && e <= Da || e >= Kr && e <= Va || e >= Ha && e <= ja || e >= 128 || e === Ua || e === Kn;
var $o = (e) => e === tt || e === zs || e === Yr || e === jr || Wt(e);
var Pa = (e) => e === Qr || e === Ls || e === Hr || e === De;
var fo = (e) => e === Ba || e === Oa || e === La || e === za;
var lt = 0;
var Wr = 2;
var De = 5;
var Ur = 6;
...
var Gr = (e, t, n) => {
  ...
  return U(u) ? r.$waitOn$.push(u.then($2)) : $2(u), l;
};
var Ue = (e) => {
...
var tu = "_wrapper_tinoh_1";
var nu = "_anchor_tinoh_6";
var su = "_privacyTerms_tinoh_19";
var ou = "_link_tinoh_24";
var ru = "_separator_tinoh_30";
var iu = "_contactInfo_tinoh_34";
var cu = "_madeBy_tinoh_34";
var Ze = { wrapper: tu, anchor: nu, privacyTerms: su, link: ou, separator: ru, contactInfo: iu, madeBy: cu };
var lu = () => _("footer", null, null, [_("div", null, { class: Ze.privacyTerms }, [_("a", null, { class: Ze.link, href: "/privacy-policy" }, "Privacy Policy", 3, null), _("span", null, { class: Ze.separator }, "|", 3, null), _("a", null, { class: Ze.link, href: "/terms-of-service" }, "Terms of Service", 3, null)], 3, null), _("div", null, { class: Ze.contactInfo }, [_("p", null, null, ["Contact us: ", _("a", null, { href: "mailto:info@dragonnetwork.digital" }, "info@dragonnetwork.digital", 3, null)], 3, null), _("p", null, null, ["Discord: ", _("a", null, { href: "https://discord.gg/ZuzbU2j5qR", target: "_blank" }, "Dragon Digital Discord", 3, null)], 3, null)], 3, null), _("div", null, { class: Ze.madeBy }, _("p", null, null, ["Website made by ", _("a", null, { href: "https://g9aerospace.in", target: "_blank" }, "G9 Aerospace", 3, null)], 3, null), 3, null)], 3, "kf_0");
var au = P(x(lu, "s_L42kk1EgXtI"));
var uu = () => T(H, { children: [T(eu, null, 3, "0q_0"), _("main", null, null, T(we, null, 3, "0q_1"), 1, null), T(au, null, 3, "0q_2")] }, 1, "0q_3");
var $u = P(x(uu, "s_wce4LNCGUkk"));
var du = Object.freeze(Object.defineProperty({ __proto__: null, default: $u }, Symbol.toStringTag, { value: "Module" }));
var fu = '((i,a,r,s)=>{r=e=>{const t=document.querySelector("[q\\\\:base]");t&&a.active&&a.active.postMessage({type:"qprefetch",base:t.getAttribute("q:base"),...e})},document.addEventListener("qprefetch",e=>{const t=e.detail;a?r(t):i.push(t)}),navigator.serviceWorker.register("/service-worker.js").then(e=>{s=()=>{a=e,i.forEach(r),r({bundles:i})},e.installing?e.installing.addEventListener("statechange",t=>{t.target.state=="activated"&&s()}):e.active&&s()}).catch(e=>console.error(e))})([])';
var Jr = ge("qc-s");
var pu = ge("qc-c");
var Xr = ge("qc-ic");
var Zr = ge("qc-h");
...
var bu = x(yu, "s_DyVc0YBIqQU");
var Su = () => {
  {
    const [e, t] = rn().chunkForSymbol(bu.getSymbol(), null), n = Ci + "build/" + t;
    return `(${vu.toString()})('${n}','${e}');`;
  }
};
var vu = async (e, t) => {
  var n;
...
var hp = P(x(xu, "s_e0ssiDXoeAM"));
var wu = (e, t) => new URL(e, t.href);
var ku = (e, t) => e.origin === t.origin;
var po = (e) => e.endsWith("/") ? e : e + "/";
var _u = ({ pathname: e }, { pathname: t }) => {
  const n = Math.abs(e.length - t.length);
  return n === 0 ? e === t : n === 1 && po(e) === po(t);
};
var Eu = (e, t) => e.search === t.search;
var Tu = (e, t) => Eu(e, t) && _u(e, t);
var Cu = (e) => e && typeof e.then == "function";
var Iu = (e, t, n, s) => {
...
var mo = (e, t) => {
  typeof t.title == "string" && (e.title = t.title), Ft(e.meta, t.meta), Ft(e.links, t.links), Ft(e.styles, t.styles), Ft(e.scripts, t.scripts), Object.assign(e.frontmatter, t.frontmatter);
};
var Ft = (e, t) => {
  if (Array.isArray(t))
    for (const n of t) {
...
var gp = () => je(Zr);
var yp = () => je(ei);
var Ru = () => bn(Os("qwikcity"));
var Au = ":root{view-transition-name:none}";
var Mu = async (e, t) => {
  const [n, s, o, r] = M(), { type: i = "link", forceReload: c = e === void 0, replaceState: l = false, scroll: a = true } = typeof t == "object" ? t : { forceReload: t }, u = o.value.dest, $2 = e === void 0 ? u : wu(e, r.url);
  if (ku($2, u) && !(!c && Tu($2, u)))
...
var Nu = (e) => {
  ...
  const s = new URL(n), o = K({ url: s, params: t.params, isNavigating: false, prevUrl: void 0 }, { deep: false }), r = {}, i = wa(K(t.response.loaders, { deep: false })), c = Ue({ type: "initial", dest: s, forceReload: false, replaceState: false, scroll: true }), l = K(ti), a = K({ headings: void 0, menu: void 0 }), u = Ue(), $2 = t.response.action, f = $2 ? t.response.loaders[$2] : void 0, m = Ue(f ? { id: $2, data: t.response.formData, output: { result: f, status: t.response.status } } : void 0), g2 = x(Mu, "s_fX0bDjeJa0E", [m, r, c, o]);
  return ue(pu, a), ue(Xr, u), ue(Zr, l), ue(ei, o), ue(mu, g2), ue(Jr, i), ue(hu, m), ue(gu, c), Fe(x(qu, "s_02wMImzEAbk", [m, a, u, l, t, g2, i, r, e, c, o])), T(we, null, 3, "qY_0");
};
var bp = P(x(Nu, "s_TxCFOy819ag"));
var Sp = (e) => _("script", { nonce: pr(e, "nonce") }, { dangerouslySetInnerHTML: fu }, null, 3, "1Z_0");
var Pu = (e, ...t) => {
  const { id: n, validators: s } = Ou(t, e);
  function o() {
    return je(Jr, (r) => {
      if (!(n in r))
...
var Lu = (e) => (vn(x(Bu, "s_a1JZ0Q0Q2Oc")), T(H, { children: e.link ? He("a", { ...e.attributes, children: S((t) => t.text, [e], "p0.text") }, { role: "button", href: S((t) => t.link, [e], "p0.link"), target: S((t) => t.openLinkInNewTab ? "_blank" : void 0, [e], 'p0.openLinkInNewTab?"_blank":undefined') }, 0, "jc_0") : He("button", { class: (() => {
  e.attributes.class;
})(), ...e.attributes, children: S((t) => t.text, [e], "p0.text") }, null, 0, null) }, 1, "jc_1"));
var zu = P(x(Lu, "s_gJoMUICXoUQ"));
var Bu = `
.button-Button {
  all: unset;
}
`;
var Fu = (e) => _("style", null, { dangerouslySetInnerHTML: S((t) => t.styles, [e], "p0.styles"), id: S((t) => t.id, [e], "p0.id") }, null, 3, "NG_0");
var xn = P(x(Fu, "s_IOsg46hMexk"));
var zt = ge("Builder");
var ht = "qwik";
function me() {
...
function Je() {
  return Du() && window.location.search.indexOf("builder.frameEditing=") !== -1;
}
...
function Bt({ code: e, context: t, localState: n, rootState: s, rootSetState: o, event: r, isExpression: i = true }) {
  if (e === "") {
  ...
  try {
    return new Function("builder", "Builder", "state", "context", "event", a)(c, c, Vu(s, n, o), t, r);
  } catch (u) {
...
var Uu = ({ block: e, context: t, localState: n, rootState: s, rootSetState: o }) => {
  if (!e.bindings)
    return e;
  const r = ni(e), i = { ...r, properties: { ...r.properties }, actions: { ...r.actions } };
  for (const c in e.bindings) {
    const l = e.bindings[c], a = Bt({ code: l, localState: n, rootState: s, rootSetState: o, context: t });
    Wu(i, c, a);
  }
  return i;
};
function Bs({ block: e, context: t, shouldEvaluateBindings: n, localState: s, rootState: o, rootSetState: r }) {
  const i = e;
  return n ? Uu({ block: i, localState: s, rootState: o, rootSetState: r, context: t }) : i;
}
var Qu = (e) => e.replace(/([a-z0-9]|(?=[A-Z]))([A-Z])/g, "$1-$2").toLowerCase();
var he = (e) => e != null;
...
var ju = () => {
  const [e] = M();
  return Bs({ block: e.block, localState: e.context.localState, rootState: e.context.rootState, rootSetState: e.context.rootSetState, context: e.context.context, shouldEvaluateBindings: true });
};
var Ku = () => {
  const [e] = M();
...
var Gu = (e) => {
  Ye();
  const t = D(x(ju, "s_9Y0pQBSnHds", [e])), n = D(x(Ku, "s_QhiYxJDtCJY", [t])), s = D(x(Yu, "s_wAetZF3ncbo", [e, t]));
  return T(H, { children: s.value && n.value ? T(xn, { get styles() {
    return s.value;
  }, [C]: { styles: S((o) => o.value, [s], "p0.value") } }, 3, "LQ_0") : null }, 1, "LQ_1");
};
var Fs = P(x(Gu, "s_r0t5qGxiwHA"));
function Ju(e) {
...
var Zu = (e) => {
  const [t, n] = M();
  return Bt({ code: n, context: t.context, localState: t.localState, rootState: t.rootState, rootSetState: t.rootSetState, event: e });
};
function e$(e, t) {
  return x(Zu, "s_7wCAiJVliNE", [t, e]);
}
function t$(e) {
...
function o$(e) {
  var n;
  const t = { ...s$(e), ...e.properties, "builder-id": e.id, style: r$(e.style), class: [e.id, "builder-block", e.class, (n = e.properties) == null ? void 0 : n.class].filter(Boolean).join(" ") };
  return t;
}
function r$(e) {
  if (e)
...
var i$ = ["area", "base", "br", "col", "embed", "hr", "img", "input", "keygen", "link", "meta", "param", "source", "track", "wbr"];
var Rn = (e) => typeof e == "string" && i$.includes(e.toLowerCase());
var c$ = ({ block: e, context: t }) => {
  var o;
  const n = (o = Bs({ block: e, localState: t.localState, rootState: t.rootState, rootSetState: t.rootSetState, context: t.context, shouldEvaluateBindings: false }).component) == null ? void 0 : o.name;
  if (!n)
    return null;
...
var l$ = ({ block: e, context: t }) => {
  const { repeat: n, ...s } = e;
  if (!(n != null && n.collection))
    return;
  const o = Bt({ code: n.collection, localState: t.localState, rootState: t.rootState, rootSetState: t.rootSetState, context: t.context });
  if (!Array.isArray(o))
    return;
...
var yo = (e) => T(H, { children: e.componentRef ? T(e.componentRef, { ...e.componentOptions, children: [(e.blockChildren || []).map(function(t) {
  ...
  return T(Fs, { block: t, get context() {
    return e.context;
...
var u$ = P(x(a$, "s_nRyVBtbGKc8"));
var $$ = () => {
  const [e] = M();
  return c$({ block: e.block, context: e.context });
};
var d$ = () => {
  const [e] = M();
  return l$({ block: e.block, context: e.context });
};
var f$ = () => {
  const [e, t] = M();
  return t.value ? e.block : Bs({ block: e.block, localState: e.context.localState, rootState: e.context.rootState, rootSetState: e.context.rootSetState, context: e.context.context, shouldEvaluateBindings: true });
};
var p$ = () => {
  const [e] = M();
...
var m$ = () => {
  const [e, t] = M();
  return t$({ block: t.value, rootState: e.context.rootState, rootSetState: e.context.rootSetState, localState: e.context.localState, context: e.context.context });
};
var h$ = () => {
  const [e, t] = M();
  return { ...o$(t.value) };
...
var y$ = () => {
  var r, i;
  const [e, t, n, s, o] = M();
  return { blockChildren: o.value.children ?? [], componentRef: (r = n.value) == null ? void 0 : r.component, componentOptions: { ...n$(o.value), ...(i = n.value) != null && i.noWrap ? { attributes: { ...t.value, ...e.value } } : {} }, context: s.childrenContext };
};
var b$ = (e) => {
  var u;
  Ye();
  const t = K({ Tag: e.block.tagName || "div", childrenContext: e.context }), n = D(x($$, "s_qb7DMTJ9XGY", [e])), s = D(x(d$, "s_NslhinGDzrU", [e])), o = D(x(f$, "s_4ZTSqMpaluI", [e, s])), r = D(x(p$, "s_82dAQcDBUzY", [o])), i = D(x(m$, "s_AOTwdXfwCqY", [e, o])), c = D(x(h$, "s_2cvnb0dCzeU", [e, o])), l = D(x(g$, "s_l4hT2V9liQc", [n, s, o])), a = D(x(y$, "s_tWa1cp0r7XY", [i, c, n, t, o]));
...
var _$ = (e) => {
  vn(x(E$, "s_0XKYzaR059E"));
  const t = je(zt), n = {}, s = D(x(v$, "s_7iQuBozD6Tc", [e]));
  return _("div", { onClick$: x(x$, "s_RzhhZa265Yg", [t, e, n]), onMouseEnter$: x(w$, "s_nG7I7RYG3JQ", [t, e, n]), onKeyPress$: x(k$, "s_N5bJZwtuEmI", [t, e, n]) }, { class: S((o) => o.value + " div-RenderBlocks", [s], 'p0.value+" div-RenderBlocks"'), "builder-path": S((o) => o.path, [e], "p0.path"), "builder-parent-id": S((o) => o.parent, [e], "p0.parent"), style: S((o) => o.styleProp, [e], "p0.styleProp") }, [e.blocks ? (e.blocks || []).map(function(o) {
    return T(wn, { block: o, context: t, [C]: { context: C } }, 3, "render-block-" + o.id);
  }) : null, e.blocks ? (e.blocks || []).map(function(o) {
    return T(Fs, { block: o, context: t, [C]: { context: C } }, 3, "block-style-" + o.id);
  }) : null], 0, "9R_0");
};
var ci = P(x(_$, "s_MYUZ0j1uLsw"));
var E$ = `
.div-RenderBlocks {
  display: flex;
...
var I$ = function(t, n, s, o) {
  const r = o === 0 ? 0 : n.gutterSize, i = C$(t, n, s, o), c = `${r}px`, l = "100%", a = 0;
...
var M$ = (e) => {
  Ye(), vn(x(N$, "s_s7JLZz7MCCQ"));
  const t = je(zt), n = K({ cols: e.columns || [], flexDir: e.stackColumnsAt === "never" ? "row" : e.reverseColumnsWhenStacked ? "column-reverse" : "column", gutterSize: typeof e.space == "number" ? e.space || 0 : 20, stackAt: e.stackColumnsAt || "tablet" }), s = D(x(R$, "s_adFEq2RWT9s", [t, e, n])), o = D(x(A$, "s_nBtMPbzd1Wc", [t, e, n]));
  return _("div", null, { class: S((r) => `builder-columns ${r.builderBlock.id}-breakpoints div-Columns`, [e], '`builder-columns ${p0.builderBlock.id}-breakpoints`+" div-Columns"'), style: S((r) => r.value, [s], "p0.value") }, [T(xn, { get styles() {
    ...
    return _("div", { style: I$(e, n, t, i) }, { class: "builder-column div-Columns-2" }, T(ci, { get blocks() {
      return r.blocks;
...
`;
var P$ = (e) => _("span", null, null, T(we, null, 3, "oj_0"), 1, "oj_1");
var O$ = P(x(P$, "s_T0AypnadAK0"));
function vo(e) {
...
function An(e) {
  ...
  if (e.match(/builder\.io/)) {
    ...
    return isNaN(s) || (n = `${n} ${s}w`), t.filter((o) => o !== s).map((o) => `${L$(e, "width", o)} ${o}w`).concat([n]).join(", ");
  }
  return e.match(/cdn\.shopify\.com/) ? t.map((n) => [z$(e, `${n}x${n}`), n]).filter(([n]) => !!n).map(([n, s]) => `${n} ${s}w`).concat([e]).join(", ") : e;
}
var B$ = () => {
  var s;
...
var V$ = (e) => {
  var o, r, i, c;
  Ye(), vn(x(U$, "s_fBMYiVf9fuU"));
  const t = D(x(B$, "s_TZMibf9Gpvw", [e])), n = D(x(F$, "s_01YCu72BBtA", [e, t])), s = D(x(D$, "s_yJ1jG0g5fbw", [e]));
...
`;
var Q$ = (e) => He("section", { ...e.attributes, style: { width: "100%", alignSelf: "stretch", flexGrow: 1, boxSizing: "border-box", maxWidth: e.maxWidth || 1200, display: "flex", flexDirection: "column", alignItems: "stretch", marginLeft: "auto", marginRight: "auto" }, children: T(we, null, 3, "2Y_0") }, null, 0, "2Y_1");
var H$ = P(x(Q$, "s_ZWF9iD5WeLg"));
var Dt = "[Builder.io]: ";
...
var ai = async (e) => li(e);
var K$ = (e) => e.map(([t, n]) => n ? `${t}=${n}` : t).filter(he).join("; ");
var Y$ = [["secure", ""], ["SameSite", "None"]];
var G$ = ({ name: e, value: t, expires: n }) => {
  const o = (me() ? location.protocol === "https:" : true) ? Y$ : [[]], r = n ? [["expires", n.toUTCString()]] : [[]], i = [[e, t], ...r, ["path", "/"], ["domain", j$(window.location.hostname)], ...o];
  return K$(i);
};
var ui = async ({ name: e, value: t, expires: n, canTrack: s }) => {
  try {
    if (!s)
      return;
    const o = G$({ name: e, value: t, expires: n });
    document.cookie = o;
  } catch (o) {
...
var J$ = "builder.tests";
var Ds = (e) => `${J$}.${e}`;
var X$ = ({ contentId: e }) => ai({ name: Ds(e), canTrack: true });
var Z$ = ({ contentId: e }) => li({ name: Ds(e), canTrack: true });
var ed = ({ contentId: e, value: t }) => ui({ name: Ds(e), value: t, canTrack: true });
var $i = (e) => he(e.id) && he(e.variations) && Object.keys(e.variations).length > 0;
var td = ({ id: e, variations: t }) => {
  var o;
  let n = 0;
  const s = Math.random();
  for (const r in t) {
...
var di = (e) => {
  const t = td(e);
  return ed({ contentId: e.id, value: t }).catch((n) => {
...
var cd = { name: "Fragment", static: true, hidden: true, canHaveChildren: true, noWrap: true };
var ld = { name: "Image", static: true, image: "https://firebasestorage.googleapis.com/v0/b/builder-3b0a2.appspot.com/o/images%2Fbaseline-insert_photo-24px.svg?alt=media&token=4e5d0ef4-f5e8-4e57-b3a9-38d63a9b9dc4", defaultStyles: { position: "relative", minHeight: "20px", minWidth: "20px", overflow: "hidden" }, canHaveChildren: true, inputs: [{ name: "image", type: "file", bubble: true, allowedFileTypes: ["jpeg", "jpg", "png", "svg"], required: true, defaultValue: "https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F72c80f114dc149019051b6852a9e3b7a", onChange: Vs((e) => {
...
var gd = (e) => {
  const t = D(x(md, "s_60AadUGY06E", [e])), n = D(x(hd, "s_ZdLsx18NYH4", [e, t]));
...
var yd = P(x(gd, "s_qdcTZflYyoQ"));
var bd = { name: "Embed", static: true, inputs: [{ name: "url", type: "url", required: true, defaultValue: "", helperText: "e.g. enter a youtube url, google map, etc", onChange: Vs((e) => {
  const t = e.get("url");
  if (t)
...
var Sd = ["text/javascript", "application/javascript", "application/ecmascript"];
var vd = (e) => Sd.includes(e.type);
var xd = function(t, n, s) {
  ...
  for (let r = 0; r < o.length; r++) {
    ...
    } else if (vd(i) && !n.scriptsRun.includes(i.innerText))
      try {
...
var wd = ({ track: e }) => {
  const [t, n, s] = M();
  e(() => t.value), e(() => s.ranInitFn), t.value && !s.ranInitFn && (s.ranInitFn = true, xd(n, s, t));
};
var kd = (e) => {
  const t = Ue(), n = K({ ranInitFn: false, scriptsInserted: [], scriptsRun: [] });
  return Fe(x(wd, "s_bg7ez0XUtiM", [t, e, n])), _("div", { ref: t }, { class: "builder-embed", dangerouslySetInnerHTML: S((s) => s.content, [e], "p0.content") }, null, 3, "9r_0");
};
var _d = P(x(kd, "s_Uji08ORjXbE"));
var Ed = (e) => He("img", { ...e.attributes }, { style: S((t) => ({ objectFit: t.backgroundSize || "cover", objectPosition: t.backgroundPosition || "center" }), [e], '{objectFit:p0.backgroundSize||"cover",objectPosition:p0.backgroundPosition||"center"}'), alt: S((t) => t.altText, [e], "p0.altText"), src: S((t) => t.imgSrc || t.image, [e], "p0.imgSrc||p0.image") }, 0, Je() && e.imgSrc || "default-key");
var Td = P(x(Ed, "s_FXvIDBSffO8"));
var Cd = { name: "Raw:Img", hideFromInsertMenu: true, image: "https://firebasestorage.googleapis.com/v0/b/builder-3b0a2.appspot.com/o/images%2Fbaseline-insert_photo-24px.svg?alt=media&token=4e5d0ef4-f5e8-4e57-b3a9-38d63a9b9dc4", inputs: [{ name: "image", bubble: true, type: "file", allowedFileTypes: ["jpeg", "jpg", "png", "svg", "gif", "webp"], required: true }], noWrap: true, static: true };
var Id = (e) => {
  const t = Ue(), n = K({ scriptsInserted: [], scriptsRun: [] });
...
var Rd = P(x(Id, "s_uYOSy7w7Zqw"));
var Ad = { name: "Custom Code", static: true, requiredPermissions: ["editCode"], inputs: [{ name: "code", type: "html", required: true, defaultValue: "<p>Hello there, I am custom HTML code!</p>", code: true }, { name: "replaceNodes", type: "boolean", helperText: "Preserve server rendered dom nodes", advanced: true }, { name: "scriptsClientOnly", type: "boolean", defaultValue: false, helperText: "Only print and run scripts on the client. Important when scripts influence DOM that could be replaced when client loads", advanced: true }] };
var Md = () => [{ component: zu, ...rd }, { component: q$, ...id }, { component: Rd, ...Ad }, { component: _d, ...bd }, { component: O$, ...cd }, { component: W$, ...ld }, { component: Td, ...Cd }, { component: H$, ...ad }, { component: Bf, ...ud }, { component: fd, ...$d }, { component: yd, ...pd }];
function qd() {
...
var mi = (e) => {
  ...
  return Object.keys(t).forEach((s) => {
    if (s.startsWith(xo)) {
      const o = s.replace(xo, "").replace(Pd, "");
      n[o] = t[s];
    }
  }), n;
};
...
var hi = (e) => e instanceof URLSearchParams ? Od(e) : e;
var zd = "v3";
var gi = (e) => {
  const { limit: t = 30, userAttributes: n, query: s, noTraverse: o = false, model: r, apiKey: i, includeRefs: c = true, enrich: l, locale: a, apiVersion: u = zd } = e;
  if (!i)
    throw new Error("Missing API key");
  if (!["v2", "v3"].includes(u))
    throw new Error(`Invalid apiVersion: expected 'v2' or 'v3', received '${u}'`);
  const $2 = new URL(`https://cdn.builder.io/api/${u}/content/${r}?apiKey=${i}&limit=${t}&noTraverse=${o}&includeRefs=${c}${a ? `&locale=${a}` : ""}${l ? `&enrich=${l}` : ""}`), f = { ...Ld(), ...hi(e.options || {}) }, m = Xn(f);
  for (const g2 in m)
...
var Fd = async (e, t) => {
  ...
  try {
    ...
    for (const o of t.results)
      s.push(await sd({ item: o, canTrack: n }));
    t.results = s;
  } catch (s) {
...
async function Dd(e) {
  try {
    const t = gi(e), n = await Bd(e);
    return yi(n) ? Fd(e, n) : (qe.error("Error fetching data. ", { url: t, content: n, options: e }), n);
  } catch (t) {
...
var Ud = async ({ canTrack: e }) => {
  ...
  {
    const n = Qd();
    return Hd({ id: n, canTrack: e }), n;
  }
};
var Qd = () => Si();
var Hd = ({ id: e, canTrack: t }) => ui({ name: vi, value: e, canTrack: t });
var xi = () => me() && typeof localStorage < "u" ? localStorage : void 0;
var jd = ({ key: e, canTrack: t }) => {
  var n;
  try {
...
var Kd = ({ key: e, canTrack: t, value: n }) => {
  var s;
  try {
...
var Yd = ({ canTrack: e }) => {
  if (!e)
    return;
  const t = jd({ key: wi, canTrack: e });
  if (he(t))
    return t;
  {
    const n = Gd();
    return Jd({ id: n, canTrack: e }), n;
  }
};
var Gd = () => Si();
var Jd = ({ id: e, canTrack: t }) => Kd({ key: wi, value: e, canTrack: t });
var Xd = () => {
  if (me()) {
...
var Zd = () => typeof navigator == "object" && "Cloudflare-Workers" || "";
var ef = () => {
  const e = Zd(), t = { Android() {
...
var tf = async ({ canTrack: e }) => {
  if (!e)
    return { visitorId: void 0, sessionId: void 0 };
  const t = await Ud({ canTrack: e }), n = Yd({ canTrack: e });
  return { sessionId: t, visitorId: n };
};
var nf = async ({ type: e, canTrack: t, apiKey: n, metadata: s, ...o }) => ({ type: e, data: { ...o, metadata: { url: location.href, ...s }, ...await tf({ canTrack: t }), userAttributes: ef(), ownerId: n } });
async function sf(e) {
  if (!e.apiKey) {
  ...
  if (e.canTrack && !Je() && (me() || ht === "reactNative"))
    return fetch("https://cdn.builder.io/api/v1/track", { method: "POST", body: JSON.stringify({ events: [await nf(e)] }), headers: { "content-type": "application/json" }, mode: "cors" }).catch((t) => {
...
var cf = (e) => {
  const t = e.target, n = t && rf(t), s = (n == null ? void 0 : n.getAttribute("builder-id")) || (n == null ? void 0 : n.id);
...
var Ut = (e) => Object.values((e == null ? void 0 : e.variations) || {}).map((t) => ({ ...t, testVariationId: t.id, id: e == null ? void 0 : e.id }));
var lf = ({ canTrack: e, content: t }) => !(!(Ut(t).length > 0) || !e || me());
function af(e, t, n) {
  var i;
  function s() {
    function c(g2, b, d) {
...
var $f = (e) => e === "react" || e === "reactNative";
var ki = $f(ht);
var _i = "builderIoAbTest";
var Ei = "builderIoRenderContent";
var df = () => {
  const e = af.toString().replace(/\s+/g, " "), t = uf.toString().replace(/\s+/g, " ");
  return `
  window.${_i} = ${e}
  window.${Ei} = ${t}
  `;
...
var pf = ({ contentId: e, variationId: t }) => `
  window.${Ei}("${t}", "${e}", ${ki})`;
var mf = (e) => {
  var r;
...
var hf = ({ customFonts: e }) => {
  var t;
  return ((t = e == null ? void 0 : e.map((n) => mf(n))) == null ? void 0 : t.join(" ")) || "";
};
var gf = ({ cssCode: e, contentId: t }) => e ? t ? (e == null ? void 0 : e.replace(/&/g, `div[builder-content-id="${t}"]`)) || "" : e : "";
var yf = (e) => {
  const t = K({ injectedStyles: `
${gf({ cssCode: e.cssCode, contentId: e.contentId })}
${hf({ customFonts: e.customFonts })}
...
var bf = P(x(yf, "s_Og0xL34Zbvc"));
var Sf = ({ content: e, data: t, locale: n }) => {
  var r, i, c;
  const s = {};
...
var vf = ({ content: e, data: t }) => e ? { ...e, data: { ...e == null ? void 0 : e.data, ...t }, meta: e == null ? void 0 : e.meta } : void 0;
...
var Ws = function(t, n, s, o) {
  n.builderContextSignal.rootState = o;
};
var wf = function(t, n, s) {
  var r, i;
  const o = (i = (r = n.builderContextSignal.content) == null ? void 0 : r.data) == null ? void 0 : i.jsCode;
  o && Bt({ code: o, context: t.context || {}, localState: void 0, rootState: n.builderContextSignal.rootState, rootSetState: Ws.bind(null, t, n, s) });
};
var kf = function(t, n, s, o) {
  var r, i;
  if (n.builderContextSignal.content) {
    ...
    sf({ type: "click", canTrack: n.canTrackToUse, contentId: l, apiKey: t.apiKey, variationId: c !== l ? c : void 0, ...cf(o), unique: !n.clicked });
  }
  n.clicked || (n.clicked = true);
};
var _f = function(t, n, s, o) {
  return o.replace(/{{([^}]+)}}/g, (r, i) => Bt({ code: i, context: t.context || {}, localState: void 0, rootState: n.builderContextSignal.rootState, rootSetState: Ws.bind(null, t, n, s) }));
};
var Ef = function(t, n, s, { url: o, key: r }) {
...
var If = ({ track: e }) => {
  const [t, n, s] = M();
  e(() => n.content), n.content && xf(n, s, t, n.content);
};
var Rf = ({ track: e }) => {
  const [t, n, s] = M();
  e(() => {
  ...
  }), e(() => s.builderContextSignal.rootState), wf(n, s, t);
};
var Af = ({ track: e }) => {
  const [t, n, s] = M();
  e(() => {
...
var Mf = ({ track: e }) => {
  const [t, n, s] = M();
  e(() => s.builderContextSignal.rootState), Cf(n, s);
};
var qf = (e) => {
  const [t, n, s] = M();
  return kf(n, s, t, e);
...
var Nf = (e) => {
  var s, o;
  Ye();
  const t = Ue(), n = K({ builderContextSignal: { content: vf({ content: e.content, data: e.data }), localState: void 0, rootState: Sf({ content: e.content, data: e.data, locale: e.locale }), rootSetState: void 0, context: e.context || {}, apiKey: e.apiKey, apiVersion: e.apiVersion, registeredComponents: [...Md(), ...Vd, ...e.customComponents || []].reduce((r, { component: i, ...c }) => ({ ...r, [c.name]: { component: i, ...c } }), {}), inheritedStyles: {} }, canTrackToUse: he(e.canTrack) ? e.canTrack : true, clicked: false, forceReRenderCount: 0, httpReqsData: {}, overrideContent: null, scriptStr: pf({ variationId: (s = e.content) == null ? void 0 : s.testVariationId, contentId: (o = e.content) == null ? void 0 : o.id }), update: 0 }, { deep: true });
  return ue(zt, n.builderContextSignal), fn(ft("s_n50dgqWW6pY", [t, e, n])), Fe(x(If, "s_Kulmlf9pM08", [t, e, n])), Fe(x(Rf, "s_X59YMGOetns", [t, e, n])), Fe(x(Af, "s_u3gn3Pj2b2s", [t, e, n])), Fe(x(Mf, "s_xLCHvjhJYRM", [t, e, n])), T(H, { children: n.builderContextSignal.content ? He("div", { ref: t, ...e.showContent ? {} : { hidden: true, "aria-hidden": true }, children: [e.isSsrAbTest ? T(Jn, { get scriptStr() {
    return n.scriptStr;
  }, [C]: { scriptStr: S((r) => r.scriptStr, [n], "p0.scriptStr") } }, 3, "03_0") : null, T(bf, { get contentId() {
    var r;
  ...
  }, [n], "p0.builderContextSignal.content?.data?.blocks") } }, 3, n.forceReRenderCount)], onClick$: x(qf, "s_wLg5o3ZkpC0", [t, e, n]) }, { "builder-content-id": S((r) => {
    var i;
    return (i = r.builderContextSignal.content) == null ? void 0 : i.id;
...
var _o = P(x(Nf, "s_hEAI0ahViXM"));
var Pf = (e) => {
  var n;
  Ye();
  const t = K({ hideVariantsStyleString: Ut(e.content).map((s) => `.variant-${s.testVariationId} { display: none; } `).join(""), shouldRenderVariants: lf({ canTrack: Gn(e.canTrack), content: e.content }), variantScriptStr: ff(Ut(e.content).map((s) => ({ id: s.testVariationId, testRatio: s.testRatio })), ((n = e.content) == null ? void 0 : n.id) || "") });
  return fn(ft("s_zc1gmoEX01g", [t])), T(H, { children: [!e.__isNestedRender && ht !== "reactNative" ? T(Jn, { scriptStr: df() }, 3, "Bz_0") : null, t.shouldRenderVariants ? T(H, { children: [T(xn, { get id() {
    var s;
  ...
  }, [C]: { scriptStr: S((s) => s.variantScriptStr, [t], "p0.variantScriptStr") } }, 3, "Bz_2"), (Ut(e.content) || []).map(function(s) {
  ...
  })] }, 1, "Bz_3") : null, T(_o, { content: t.shouldRenderVariants ? e.content : nd({ item: e.content, canTrack: Gn(e.canTrack) }), get classNameProp() {
    var s;
...
var Ti = P(x(Pf, "s_OMvvre8Ofjw"));
var Of = function(t, n, s) {
  var o, r;
...
var zf = (e) => {
  ...
  return fn(ft("s_oMPs8W5ZhwE", [t, e, n])), Fe(x(Lf, "s_NIAWAC1bMBo", [t, e, n])), He("div", { ...e.attributes, children: T(Ti, { get apiVersion() {
    return t.apiVersion;
  }, get apiKey() {
    return t.apiKey;
  }, get context() {
...
var Bf = P(x(zf, "s_WVvggdkUPdk"));
var Ff = "_wrapper_u67uf_1";
var Df = "_button_u67uf_8";
var Mn = { wrapper: Ff, button: Df };
var Vf = "_wrapper_ypdzw_1";
var Wf = "_gauge_ypdzw_5";
var Uf = "_value_ypdzw_10";
var qn = { wrapper: Vf, gauge: Wf, value: Uf };
var Qf = (e) => {
...
var Hf = P(x(Qf, "s_mMbjgespiYw"));
var jf = (e) => {
  const [t] = M();
  e >= 0 && e <= 100 && (t.value = e, e === 100 && Jf());
};
var Kf = (e) => {
  const t = Ue(e.initialValue || 99), n = x(jf, "s_70qR4CRbrV4", [t]);
  return _("div", null, { class: Mn.wrapper }, [_("button", null, { class: Mn.button, onClick$: ft("s_d1ZjguXclSk", [t, n]) }, "-", 3, null), T(Hf, { get value() {
    return t.value;
  }, [C]: { value: S((s) => s.value, [t], "p0.value") } }, 3, "l5_0"), _("button", null, { class: Mn.button, onClick$: ft("s_Cw830x7OM1Q", [t, n]) }, "+", 3, null)], 1, "l5_1");
};
var Yf = P(x(Kf, "s_CgASKt86Ilk"));
var Gf = async () => {
...
var Jf = x(Gf, "s_5L0V8IRw5RM");
var Xf = [{ component: Yf, name: "Counter", inputs: [{ name: "initialValue", type: "number" }] }];
var Zf = async ({ url: e, error: t }) => {
...
var ep = () => {
  ...
  }, customComponents: Xf, [C]: { apiKey: C, content: S((t) => t.value, [e], "p0.value"), customComponents: C, model: C } }, 3, "ZY_0");
};
var tp = P(x(ep, "s_QHfu0Jk0asc"));
var np = ({ resolveValue: e }) => {
  var n;
  const t = e(Us);
  return { title: (n = t == null ? void 0 : t.data) == null ? void 0 : n.title };
};
var sp = Object.freeze(Object.defineProperty({ __proto__: null, default: tp, head: np, useBuilderContent: Us }, Symbol.toStringTag, { value: "Module" }));
var op = [];
var rp = () => du;
var ip = [["[...index]", [rp, () => sp], "/[...index]", ["q-DyCyW6bd.js", "q-Blz1cvbM.js"]]];
var cp = [];
var lp = true;
var Ci = "/";
var ap = true;
var vp = { routes: ip, serverPlugins: op, menus: cp, trailingSlash: lp, basePathname: Ci, cacheModules: ap };

// ../server/q-DkUqNl9m.js
var ye = ((e) => typeof __require < "u" ? __require : typeof Proxy < "u" ? new Proxy(e, { get: (n, s) => (typeof __require < "u" ? __require : n)[s] }) : e)(function(e) {
...
function J2(e, n) {
  ...
  return { isServer: true, async importSymbol(i, a, r) {
    var j3;
    const c = N2(r), l = (j3 = globalThis.__qwik_reg_symbols) == null ? void 0 : j3.get(c);
    if (l)
      return l;
    let m = String(a);
    m.endsWith(".js") || (m += ".js");
...
function xe2(e = {}) {
  return Array.isArray(e.events) && e.events.length > 0 ? (e.debug ? ke2 : ge2).replace("window.qEvents", JSON.stringify(e.events)) : e.debug ? we2 : je2;
}
function ve2(e, n, s) {
  if (!s)
    return [];
  const t = n.prefetchStrategy, o = G2(n);
  if (t !== null) {
...
function Se2(e, n, s) {
  const t = Le2(e == null ? void 0 : e.implementation), o = [];
  return t.prefetchEvent === "always" && Ie2(o, n, s), t.linkInsert === "html-append" && Ee2(o, n, t), t.linkInsert === "js-append" ? Ae2(o, n, t, s) : t.workerFetchInsert === "always" && Fe2(o, n, s), o.length > 0 ? dp(H, { children: o }) : null;
}
function Ie2(e, n, s) {
  const t = ze2(n);
  for (const o of t)
    e.push(dp("link", { rel: "modulepreload", href: o, nonce: s }));
  e.push(dp("script", { "q:type": "prefetch-bundles", dangerouslySetInnerHTML: Be2(n) + ";document.dispatchEvent(new CustomEvent('qprefetch', {detail:{links: [location.pathname]}}))", nonce: s }));
}
function Ee2(e, n, s) {
  const t = g(n), o = s.linkRel || "prefetch";
  for (const i of t) {
    const a = {};
    a.href = i, a.rel = o, (o === "prefetch" || o === "preload") && i.endsWith(".js") && (a.as = "script"), e.push(dp("link", a, void 0));
  }
}
function Ae2(e, n, s, t) {
  const o = s.linkRel || "prefetch";
  let i = "";
  s.workerFetchInsert === "no-link-support" && (i += "let supportsLinkRel = true;"), i += `const u=${JSON.stringify(g(n))};`, i += "u.map((u,i)=>{", i += "const l=document.createElement('link');", i += 'l.setAttribute("href",u);', i += `l.setAttribute("rel","${o}");`, s.workerFetchInsert === "no-link-support" && (i += "if(i===0){", i += "try{", i += `supportsLinkRel=l.relList.supports("${o}");`, i += "}catch(e){}", i += "}"), i += "document.body.appendChild(l);", i += "});", s.workerFetchInsert === "no-link-support" && (i += "if(!supportsLinkRel){", i += C2(), i += "}"), s.workerFetchInsert === "always" && (i += C2()), e.push(dp("script", { type: "module", "q:type": "link-js", dangerouslySetInnerHTML: i, nonce: t }));
}
function Fe2(e, n, s) {
  let t = `const u=${JSON.stringify(g(n))};`;
  t += C2(), e.push(dp("script", { type: "module", "q:type": "prefetch-worker", dangerouslySetInnerHTML: t, nonce: s }));
}
function Le2(e) {
  return { ...Te2, ...e };
}
...
async function Re2(e, n) {
  var L2;
  let s = n.stream, t = 0, o = 0, i = 0, a = 0, r = "", c;
  const l = ((L2 = n.streaming) == null ? void 0 : L2.inOrder) ?? { strategy: "auto", maximunInitialChunk: 5e4, maximunChunk: 3e4 }, m = n.containerTagName ?? "html", w = n.containerAttributes ?? {}, j3 = s, ne3 = v(), se3 = G2(n), _2 = ee2(n.manifest);
  function z2() {
    r && (j3.write(r), r = "", t = 0, i++, i === 1 && (a = ne3()));
  }
  function S2(d) {
    const p = d.length;
    t += p, o += p, r += d;
  ...
  switch (l.strategy) {
    ...
    case "auto":
      let d = 0, p = false;
      const T2 = l.maximunChunk ?? 0, k2 = l.maximunInitialChunk ?? 0;
      s = { write(b) {
        b === "<!--qkssr-f-->" ? p || (p = true) : b === "<!--qkssr-pu-->" ? d++ : b === "<!--qkssr-po-->" ? d-- : S2(b), d === 0 && (p || t >= (i === 0 ? k2 : T2)) && (p = false, z2());
      } };
      break;
  }
  m === "html" ? s.write(De2) : (s.write("<!--cq-->"), n.qwikLoader ? (n.qwikLoader.include === void 0 && (n.qwikLoader.include = "never"), n.qwikLoader.position === void 0 && (n.qwikLoader.position = "bottom")) : n.qwikLoader = { include: "never" }, n.qwikPrefetchServiceWorker || (n.qwikPrefetchServiceWorker = {}), n.qwikPrefetchServiceWorker.include || (n.qwikPrefetchServiceWorker.include = false), n.qwikPrefetchServiceWorker.position || (n.qwikPrefetchServiceWorker.position = "top")), n.manifest || console.warn("Missing client manifest, loading symbols in the client might 404. Please ensure the client build has run and generated the manifest for the server build."), await he2(n, _2);
  const I2 = _2 == null ? void 0 : _2.manifest.injections, te3 = I2 ? I2.map((d) => dp(d.tag, d.attributes ?? {})) : void 0, ie3 = v(), E2 = [];
  let A2 = 0, F3 = 0;
  await $p(e, { stream: s, containerTagName: m, containerAttributes: w, serverData: n.serverData, base: se3, beforeContent: te3, beforeClose: async (d, p, T2, k2) => {
    var O2, V3, Q2, K3, Y3, P3, Z2;
    A2 = ie3();
    const b = v();
    c = await Ml(d, p, void 0, k2);
    const y = [];
    if (n.prefetchStrategy !== null) {
      const f = ve2(c, n, _2);
      if (f.length > 0) {
        const U2 = Se2(n.prefetchStrategy, f, (O2 = n.serverData) == null ? void 0 : O2.nonce);
        U2 && y.push(U2);
      }
    }
    const re3 = JSON.stringify(c.state, void 0, void 0);
    y.push(dp("script", { type: "qwik/json", dangerouslySetInnerHTML: Me2(re3), nonce: (V3 = n.serverData) == null ? void 0 : V3.nonce })), c.funcs.length > 0 && y.push(dp("script", { "q:func": "qwik/json", dangerouslySetInnerHTML: Qe2(c.funcs), nonce: (Q2 = n.serverData) == null ? void 0 : Q2.nonce }));
    const ae3 = !c || c.mode !== "static", D2 = ((K3 = n.qwikLoader) == null ? void 0 : K3.include) ?? "auto", R2 = D2 === "always" || D2 === "auto" && ae3;
    if (R2) {
      const f = xe2({ events: (Y3 = n.qwikLoader) == null ? void 0 : Y3.events, debug: n.debug });
      y.push(dp("script", { id: "qwikloader", dangerouslySetInnerHTML: f, nonce: (P3 = n.serverData) == null ? void 0 : P3.nonce }));
    }
    const M2 = Array.from(p.$events$, (f) => JSON.stringify(f));
    if (M2.length > 0) {
      let f = `window.qwikevents.push(${M2.join(", ")})`;
      R2 || (f = `window.qwikevents||=[];${f}`), y.push(dp("script", { dangerouslySetInnerHTML: f, nonce: (Z2 = n.serverData) == null ? void 0 : Z2.nonce }));
    }
    return Oe2(E2, d), F3 = b(), dp(H, { children: y });
  }, manifestHash: (_2 == null ? void 0 : _2.manifest.manifestHash) || "dev" }), m !== "html" && s.write("<!--/cq-->"), z2();
  const oe3 = c.resources.some((d) => d._cache !== 1 / 0);
  return { prefetchResources: void 0, snapshotResult: c, flushes: i, manifest: _2 == null ? void 0 : _2.manifest, size: o, isStatic: !oe3, timing: { render: A2, snapshot: F3, firstFlush: a }, _symbols: E2 };
}
function ee2(e) {
  if (e) {
    if ("mapper" in e)
...
var Me2 = (e) => e.replace(/<(\/?script)/gi, "\\x3C$1");
function Oe2(e, n) {
  var s;
  for (const t of n) {
...
var Pe2 = P(x(Ye2, "s_2ZLchhq7kSo"));
var Ze2 = () => T(bp, { children: [_("head", null, null, [_("meta", null, { charSet: "utf-8" }, null, 3, null), _("link", null, { href: "/manifest.json", rel: "manifest" }, null, 3, null), T(Pe2, null, 3, "0V_0"), T(Sp, null, 3, "0V_1")], 1, null), _("body", null, { lang: "en" }, T(hp, null, 3, "0V_2"), 1, null)] }, 1, "0V_3");
var Ue2 = P(x(Ze2, "s_WyLAiKEY0TQ"));
function Je2(e) {
  return Re2(T(Ue2, null, 3, "i1_0"), { manifest: Ke2, ...e, containerAttributes: { lang: "en-us", ...e.containerAttributes } });
}
...
var ze3 = (e, t, n, r, a) => {
  const i = [], s = [], o = [], l = !!(t && Ge2(t[2]));
  if (e && J3(i, s, o, e, l, n), t) {
    const c = t[0];
    r && (n === "POST" || n === "PUT" || n === "PATCH" || n === "DELETE") && o.unshift(Je3), l && (n === "POST" && o.push(Be3), o.push(Ke3), o.push(Ze3)), o.push(Ye3), J3(i, s, o, t[2], l, n), l && (o.push((d) => {
...
function rt2(e, t, n, r, a, i, s, o) {
  ...
  const we3 = async () => {
    ...
    return Q2();
  }, Q2 = () => (w = q2, new j2()), U2 = {}, T2 = { [ce2]: U2, [le2]: e.mode, [ue2]: a, [fe2]: t, [v2]: s, cookie: m, headers: u, env: d, method: l.method, signal: l.signal, params: (t == null ? void 0 : t[1]) ?? {}, pathname: g2.pathname, platform: c, query: g2.searchParams, request: l, url: g2, basePathname: i, sharedMap: h, get headersSent() {
    return y !== null;
  }, get exited() {
    return w >= q2;
  }, get clientConn() {
    ...
    const p = f.__id;
    if (f.__brand === "server_loader" && !(p in U2))
      throw new Error("You can not get the returned data of a loader that has not been executed for this request.");
    return U2[p];
    ...
    return u.delete("Cache-Control"), f > 301 && u.set("Cache-Control", "no-store"), Q2(), new W();
...
function yt2(e) {
  ...
  const t = { _deserializeData: fp, _serializeData: pp, _verifySerializable: mp };
...
var Ct2 = yt2({ render: Je2, qwikCityPlan: vp, manifest: Ke2 });
...
// ../.wrangler/tmp/bundle-dr4MqY/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-dr4MqY/middleware-loader.entry.ts
...
* found in the LICENSE file at https://github.com/BuilderIO/qwik/blob/main/LICENSE
*/
//# sourceMappingURL=bundledWorker-0.804051376925591.mjs.map
